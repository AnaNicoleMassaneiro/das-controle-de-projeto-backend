...
public abstract class ClientMapper {
    ...
    public abstract Client toClient(ClientPostRequestBody productPostRequestBody);

    public abstract Client toClient(ClientPutRequestBody productPostRequestBody);
